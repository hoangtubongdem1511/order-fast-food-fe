import { Box, Button, Card, CardActions, CardHeader, Modal } from '@mui/material'
        ...
        {ingredients.ingredients.map((item) => (
          ...
          >
            ...
            <TableCell align="right">
              <Button onClick={() => handleUpdateStoke(item.id)}>{item.inStoke ? "in stoke" : "out of stoke"}</Button>
            </TableCell>
          </TableRow>
        ))}
      </TableBody>
